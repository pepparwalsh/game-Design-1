...
enum STATES { IDLE=0, DEAD, DAMAGED, ATTACKING, CHANGING }
...
var animation_lock = 0.0 # locl player while playing attack animation
...
func attack():
	...
	slash.rotation = Vector2().angle_to_point(-attack_dirction)
	add_child(slash)
	animation_lock = 0.2
